...
--
-- Table structure for table `it.unipi.dii.inginf.lsdb.library.book.book`
--

DROP TABLE IF EXISTS `it.unipi.dii.inginf.lsdb.library.book.book`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `it.unipi.dii.inginf.lsdb.library.book.book` (
...
CREATE TABLE `book_has_author` (
  ...
  CONSTRAINT `book_idbook` FOREIGN KEY (`book_idbook`) REFERENCES `it.unipi.dii.inginf.lsdb.library.book.book` (`idbook`) ON DELETE CASCADE ON UPDATE CASCADE
